...
namespace KwikNesta.Contracts.Models
{
    public class PropertyNotificationEvent
    {
        ...
        public static PropertyNotificationEvent Init(string userId,
                                                            ...
                                                            string? propertyStatus)
        {
            return type switch
            {
                PropertyNotificationType.AutoVerified => (
                                        type.GetDescription(),
                ...
                PropertyNotificationType.VerificationFailed => (
                                        type.GetDescription(),
                ...
                PropertyNotificationType.DocumentApproved => (
                                        type.GetDescription(),
                ...
                PropertyNotificationType.DocumentRejected => (
                                        type.GetDescription(),
                ...
                PropertyNotificationType.Created => (
                                        type.GetDescription(),
                ...
                PropertyNotificationType.Updated => (
                                        type.GetDescription(),
                ...
                PropertyNotificationType.DocumentUploaded => (
                                        type.GetDescription(),
                ...
                PropertyNotificationType.ManualVerificationRequested => (
                                        type.GetDescription(),
                ...
                PropertyNotificationType.StatusChanged => (
                                        type.GetDescription(),
